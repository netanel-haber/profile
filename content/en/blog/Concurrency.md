...
What should be taken from this article, written with minimal buzzwords and languages dropping, is the basic foundation of concepts needed to explore the solution space for each language.
